...
public class GroupsDashboard extends AbstractPage {
    ...
    private static String XPATH_GROUP_NAME = "//div[@data-aura-class='forceChatterCompoundFieldsGroupName']/descendant::a[text()='%s']";
    ...
    public boolean searchBox(String search) {
        ...
        String xpathRow = String.format(XPATH_GROUP_NAME, search);
        return action.isElementVisible(By.xpath(xpathRow));
    }

    public boolean isInList(String groupName) {
        String xpathRow = String.format(XPATH_GROUP_NAME, groupName);
        return action.isElementVisible(By.xpath(xpathRow));
    }
